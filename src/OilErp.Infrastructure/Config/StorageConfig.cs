...
/// <param name="CommandTimeoutSeconds">Таймаут команд в секундах</param>
/// <param name="DisableRoutineMetadataCache">Отключить кеш pg_proc/сигнатур (для диагностики)</param>
